      ...
      <section className="w-full flex flex-col md:flex-row items-start md:items-center gap-6 glass-panel p-6 rounded-xl border-t-4 border-t-[#B3261E]">
        ...
        <div className="flex-grow">
          <div className="flex items-center gap-3">
            <h1 className="font-display text-3xl md:text-5xl font-bold text-[#231A16] tracking-tight">System Administrator</h1>
        ...
        <button
          ...
          className="px-6 py-3 bg-[#B7322A] text-[#FDF8F0] font-[Inter] text-xs font-semibold tracking-[0.05em] uppercase rounded-xl hover:shadow-[0_0_9px_rgba(183,50,42,0.17)] transition-all duration-300 whitespace-nowrap"
        >
          Edit Account
        </button>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 glass-panel p-6 rounded-xl flex flex-col transition-all duration-300 min-h-[280px]">
          <div className="flex items-center justify-between mb-6 flex-wrap gap-2">
            <div className="flex items-center gap-3 text-[#B7322A]">
              <Users size={28} />
              <h2 className="font-display text-2xl font-semibold text-[#231A16]">Seller Management</h2>
            </div>
          ...
          <div className="mb-7">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-display text-xs font-bold uppercase tracking-wider text-[#C8901A]">Seller Requests</h3>
            ...
            <div className="flex flex-col gap-3">
              {requests.length === 0 && (
                <div className="bg-[#F0E7DA]/30 p-5 rounded-xl border border-dashed border-[#231a16]/10 text-center text-[#8A7B6B] text-sm">
                  No pending requests — you're all caught up.
                </div>
              )}
              {requests.map((req) => (
                <div key={req.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-[#F0E7DA]/40 p-3 rounded-xl border border-[#231a16]/5 hover:border-[#C8901A]/30 transition-colors">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="font-display font-semibold text-[#231A16] truncate">{req.store}</p>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button onClick={() => approveSeller(req.id)} disabled={busy} className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl bg-[#7A1F1A]/50 hover:bg-[#B7322A]/20 border border-[#B7322A]/30 text-[#231A16] text-xs font-semibold transition-all disabled:opacity-50">
                      <Check size={14} /> Approve
                    </button>
                    <button onClick={() => rejectSeller(req.id)} disabled={busy} className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl bg-[#F7D5D2]/40 hover:bg-[#B3261E]/20 border border-[#B3261E]/30 text-[#B3261E] text-xs font-semibold transition-all disabled:opacity-50">
                      <X size={14} /> Reject
                    </button>
                  </div>
                </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-display text-xs font-bold uppercase tracking-wider text-[#B7322A]">Approved Sellers</h3>
            ...
            <div className="flex flex-col gap-3">
              ...
              {approved.map((s) => (
                <div key={s.id} className="flex items-center justify-between gap-3 bg-[#F0E7DA]/40 p-3 rounded-xl border border-[#231a16]/5 hover:border-[#B7322A]/30 transition-colors">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="font-display font-semibold text-[#231A16] truncate flex items-center gap-1.5">
        ...
        <div className="lg:col-span-4 glass-panel p-6 rounded-xl flex flex-col group transition-all duration-300 min-h-[280px]">
          <div className="flex items-center gap-3 text-[#B3261E] mb-6">
            ...
            <h2 className="font-display text-2xl font-semibold text-[#231A16]">Security</h2>
          </div>

          <div className="space-y-4">
            <button className="w-full text-left bg-[#B3261E]/10 hover:bg-[#B3261E]/20 p-3 rounded-xl transition-colors border border-[#B3261E]/20">
