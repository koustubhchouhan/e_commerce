  ...
  return (
    <div className="max-w-[1200px] mx-auto px-6 py-12 md:px-12 md:py-16 animate-fade-in-up">
      <div className="text-center mb-16">
        <h1 className="text-glow font-display text-5xl font-bold text-[#231A16] mb-6">About NovaMarket</h1>
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <GlassCard className="p-8">
            <h3 className="font-display text-xl font-bold text-[#B7322A] mb-3">Futuristic UI</h3>
            <p className="text-[#7A6A5B] text-sm">A seamless glassmorphic design that puts your shopping experience first.</p>
          </GlassCard>
          <GlassCard className="p-8">
            <h3 className="font-display text-xl font-bold text-[#B7322A] mb-3">Verified Sellers</h3>
            <p className="text-[#7A6A5B] text-sm">Every seller is strictly vetted by our admin team before listing products.</p>
          </GlassCard>
          <GlassCard className="p-8">
            <h3 className="font-display text-xl font-bold text-[#B7322A] mb-3">Next-Gen Tech</h3>
