  ...
  return (
    <div className="max-w-[1200px] mx-auto px-12 py-16 animate-fade-in-up">
      <div className="text-center mb-16">
        <h1 className="text-glow font-[Outfit] text-5xl font-bold text-[#231A16] mb-6">About NovaMarket</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
        <GlassCard className="p-10 flex flex-col justify-center border-l-4 border-l-[#B7322A]">
          <h2 className="font-[Outfit] text-3xl font-bold text-[#231A16] mb-4">Our Vision</h2>
        ...
        <GlassCard className="p-10 flex flex-col justify-center border-l-4 border-l-[#B8860B]">
          <h2 className="font-[Outfit] text-3xl font-bold text-[#231A16] mb-4">Our Mission</h2>
          <p className="text-[#7A6A5B] leading-relaxed">
      ...
      <div className="text-center">
        <h2 className="font-[Outfit] text-3xl font-bold text-[#231A16] mb-8">Why Choose Us?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <GlassCard className="p-8">
            <h3 className="font-[Outfit] text-xl font-bold text-[#B7322A] mb-3">Futuristic UI</h3>
            <p className="text-[#7A6A5B] text-sm">A seamless glassmorphic design that puts your shopping experience first.</p>
          </GlassCard>
          <GlassCard className="p-8">
            <h3 className="font-[Outfit] text-xl font-bold text-[#B7322A] mb-3">Verified Sellers</h3>
            <p className="text-[#7A6A5B] text-sm">Every seller is strictly vetted by our admin team before listing products.</p>
          </GlassCard>
          <GlassCard className="p-8">
            <h3 className="font-[Outfit] text-xl font-bold text-[#B7322A] mb-3">Next-Gen Tech</h3>
            <p className="text-[#7A6A5B] text-sm">We focus exclusively on high-performance, futuristic electronics and gear.</p>
          </GlassCard>
        </div>
      </div>
    </div>
